...
void HdrImage::writeTiff(const char filename[], float gamma){
	// Open output file, or throw exception on failure.
	FILE *f = fopen(filename, "wb");
	if (!f)
		throw runtime_error("Error: Could not open file");
...
void HdrImage::writeBmp(const char filename[], float gamma){
	// Open output file, or throw exception on failure.
	FILE *f = fopen(filename, "wb");
	if (!f)
		throw runtime_error("Error: Could not open file");
...
void HdrImage::writeGif(const char filename[], float gamma) {
	// Open output file, or throw exception on failure.
	FILE *f = fopen(filename, "wb");
	if (!f)
		throw runtime_error("Error: Could not open file");
